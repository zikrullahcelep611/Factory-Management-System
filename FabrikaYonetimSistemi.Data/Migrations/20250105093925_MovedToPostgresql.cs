...
{
    /// <inheritdoc />
    public partial class MovedToPostgresql : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    StorageMaterialId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialRequests_StorageMaterials_StorageMaterialId",
                        column: x => x.StorageMaterialId,
                        principalTable: "StorageMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialTransactions_AspNetUsers_PersonnelId",
                        column: x => x.PersonnelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialTransactions_StorageMaterials_StorageMaterialId",
                        column: x => x.StorageMaterialId,
                        principalTable: "StorageMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
